...
# 模型保存路径
model_path = "./model/bilstm_crf_state_dict_20201025_153550.pt"
...
if __name__ == '__main__':
    # entities = single_predict(model_path, content, char_to_id_json_path, EMBEDDING_DIM,
    #                           HIDDEN_DIM, target_type_list, tag_to_id)
    # print("entities:", entities)
    batch_predict(data_path, model_path, char_to_id_json_path, EMBEDDING_DIM,
                  HIDDEN_DIM, target_type_list, prediction_result_path, tag_to_id)
